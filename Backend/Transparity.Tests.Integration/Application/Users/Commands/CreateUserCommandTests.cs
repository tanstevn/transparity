    ...
    public class CreateUserCommandTests : BaseIntegrationTest<CreateUserCommandTests,
        ...
        public void CreateUserCommand_Runs_Successfully() {
            Arrange(request => {
                ...
                request.RoleId = RoleEnums.Anonymous;
            })
            .Act()
            .Assert(result => {
                result.Successful
        ...
        [Fact]
        public void CreateUserCommand_UserId_Param_Throws_ValidationException() {
            Arrange(request => {
        ...
        [Fact]
        public void CreateUserCommand_RoleId_Param_Throws_ValidationException() {
            Arrange(request => {
                request.UserId = Guid.NewGuid();
                request.Info = new UserInfoRecord(
                    FirstName: "Test FirstName",
        ...
        [Fact]
        public void CreateUserCommand_Info_Param_Throws_ValidationException() {
